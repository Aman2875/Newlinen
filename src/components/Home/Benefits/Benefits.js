          ...
          <div className="what-is-text-content__right-subtitle">
            <div className="code-embed w-embed">
              <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M6.65636 12.7577C6.12239 12.0475 5.26031 11.5854 4.28857 11.5854C3.70786 11.5854 3.1667 11.75 2.71094 12.034" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M9.30031 10.9389C8.53891 10.4076 7.54738 10.0498 6.53878 10.0498C4.92699 10.0498 3.50128 10.8139 2.66797 12.0293" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10.8882 7.63641C10.1844 7.36314 9.37351 7.20312 8.56627 7.20312C5.57012 7.20312 3.0567 9.26528 2.59375 11.9828" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M0.332031 8.84277C1.63459 9.11695 2.58476 10.291 2.58476 11.7086C2.58476 11.7913 2.57757 11.8982 2.57128 11.9792" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M0.734375 5.64893C2.17267 6.4274 3.10666 7.95379 3.10666 9.73818C3.10666 10.5625 2.93407 11.3077 2.5664 11.9792" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M3.25407 3.24316C4.3247 4.29312 4.95935 5.7404 4.95935 7.38006C4.95935 9.31636 4.09458 10.9839 2.66797 12.0293" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6.5793 1.93994C7.56183 3.02136 8.15153 4.47224 8.15153 6.08852C8.15153 9.41368 5.84487 12.044 2.69141 12.044" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M2.56879 11.9793C2.21911 11.1271 0.865314 7.35065 4.45206 5.55728C4.45206 5.55728 4.96715 5.17793 8.10982 4.58193C9.84027 4.25382 10.7006 3.98324 11.124 3.80615" stroke="currentColor" strokeWidth="0.3" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <div className="text-body">Benefits</div>
          </div>
            ...
            <div className="grid-dashboard-benefits">
              <div className="container-benefits-card">
                <div className="benefits-card small-benefits-card">
                  <div className="text-h4 font-medium">Effortless linen leasing with built-in sustainability</div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card medium-benefits-card">
                  <div className="text-h4 font-medium">Smart RFID tracking for real-time linen monitoring</div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card large-benefits-card">
                  <div className="text-h3 font-medium benefits-card__title">AI-powered stain detection for precise sorting and reduced waste</div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card small-benefits-card">
                  <div className="text-h3 font-medium">Eco-friendly washing with optimized water and energy use</div>
                  <div className="benefits-card__bg w-embed">
                    <svg width="361" height="439" viewBox="0 0 361 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
              ...
              <div className="container-benefits-card">
                <div className="benefits-card large-benefits-card">
                  <div className="text-h3 font-medium">Automated inventory management for zero disruptions</div>
                  <div className="text-body"></div>
                  <div className="benefits-card__bg w-embed">
              ...
              <div className="container-benefits-card">
                <div className="benefits-card medium-benefits-card">
                  <div className="text-h4 font-medium">Platform  for sustainable linen solutions</div>
                  <div className="benefits-card__bg w-embed">
