    ...
    <>
      ...
      <div class="w-layout-blockcontainer container w-container">
                    <div class="container-product-hero">
                        ...
                        <h1 animate="title" class="text-h1 font-medium no-margins on-mobile">Laundries</h1>
                        <div class="description-product-hero">
                            <h2 delay="0.2" animate="text" class="text-h5 font-light no-margins">Optimize linen care, reduce waste, and enhance operational efficiency with Linengrass.</h2>
                        </div>
                    </div>
                </div>
        <div className="lines-bg-product-hero" animate="circular-lines">
