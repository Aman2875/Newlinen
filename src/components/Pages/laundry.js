...
const Laundry = () => {
  useEffect(() => {
    // Set document title
    document.title = 'Laundries - Linengrass';
    ...
    // Custom implementation for benefits section animation
    const benefitsSection = document.querySelector('[animate="benefits-section"]');
    if (benefitsSection) {
      // Add intersection observer to animate when in view
  ...
  return (
    <div>
        ...
        <div className="w-layout-blockcontainer container w-container">
          <div className="container-product-hero">
            ...
            <h1 className="text-h1 font-medium no-margins on-mobile words splitting" data-animate="title">
              <span className="word" data-word="Laundries">Laundries</span>
            </h1>
            <div className="description-product-hero">
              <h2 className="text-h5 font-light no-margins words lines splitting" data-animate="text" data-delay="0.2">
                ...
                <span className="word">linen</span>
                <span className="whitespace"> </span>
                ...
                <span className="whitespace"> </span>
                <span className="word">operational</span>
                <span className="whitespace"> </span>
                <span className="word">efficiency</span>
                <span className="whitespace"> </span>
                <span className="word">with</span>
                <span className="whitespace"> </span>
                <span className="word">Linengrass.</span>
              </h2>
            </div>
          </div>
        </div>
      ...
      <section el="image-separator-section" className="small-image-parallax-section" style={{height: '0px'}}>
        <div className="image-small-image-parallax-section"></div>
      </section>
      ...
      <section className="section product-showcase-section">
        <div className="w-layout-blockcontainer container container---product-showcase w-container">
          <div className="content---product-showcase">
            <div className="text-h2 words splitting" el="slider/title" animate="title" style={{"--word-total": "1"}} in-view="true">
              <span className="word" data-word="Wallet" style={{"--word-index": "0"}}>Wallet</span>
            </div>
            <div className="text-body words lines splitting" el="slider/description" animate="text" delay="0.5" style={{"--word-total": "7", "--line-total": "1"}} in-view="true">
              <span className="word" data-word="Scope" style={{"--word-index": "0", "--line-index": "0"}}>Scope</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="3" style={{"--word-index": "1", "--line-index": "0"}}>3</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="employee" style={{"--word-index": "2", "--line-index": "0"}}>employee</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="and" style={{"--word-index": "3", "--line-index": "0"}}>and</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="student" style={{"--word-index": "4", "--line-index": "0"}}>student</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="commuting" style={{"--word-index": "5", "--line-index": "0"}}>commuting</span>
              <span className="whitespace"> </span>
              <span className="word" data-word="emissions" style={{"--word-index": "6", "--line-index": "0"}}>emissions</span>
            </div>
          </div>
        </div>
        <div className="slider-container---product-showcase">
          <div className="commuters-product-slider-component" el="product-preview-slider">
            <div className="w-layout-blockcontainer container w-container">
            ...
            <div className="tns-outer" id="tns1-ow">
              ...
              <div id="tns1-mw" className="tns-ovh">
                <div className="tns-inner" id="tns1-iw">
                  <div className="wrapper---commuters-product-slider tns-slider tns-carousel tns-subpixel tns-calc tns-autowidth tns-horizontal" 
                    el="slider/product-preview-slider" 
                    id="tns1" 
                    item-active="0" 
                    style={{transitionDuration: "0s", transform: "translate3d(0px, 0px, 0px)"}}>
                    <div className="media---commuters-product-slider tns-item tns-slide-active" id="tns1-item0" description="Scope 3 employee and student commuting emissions" title="Wallet">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c70_commuters%20preview%2001.webp" loading="eager" width="500" alt="" className="image---businesses-product-slider-copy loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item tns-slide-active" id="tns1-item1" description="Scope 3 employee and student commuting emissions" title="Overall View">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c71_commuters%20preview%2002.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item tns-slide-active" id="tns1-item2" description="Scope 3 employee and student commuting emissions" title="Start Journey">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c72_commuters%20preview%2003.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item" id="tns1-item3" description="Scope 3 employee and student commuting emissions" title="Challenges/ Competitions" aria-hidden="true" tabIndex="-1">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c73_commuters%20preview%2004.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item" id="tns1-item4" description="Scope 3 employee and student commuting emissions" title="Journeys" aria-hidden="true" tabIndex="-1">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c74_commuters%20preview%2005.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item" id="tns1-item5" description="Scope 3 employee and student commuting emissions" title="Shop" aria-hidden="true" tabIndex="-1">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c75_commuters%20preview%2006.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item" id="tns1-item6" description="Scope 3 employee and student commuting emissions" title="E-Commerce" aria-hidden="true" tabIndex="-1">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c76_commuters%20preview%2007.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                    <div className="media---commuters-product-slider tns-item" id="tns1-item7" description="Scope 3 employee and student commuting emissions" title="Vouchers" aria-hidden="true" tabIndex="-1">
                      <img src="https://cdn.prod.website-files.com/6694e750ddf5484a13b68bbc/6694e750ddf5484a13b68c77_commuters%20preview%2008.webp" loading="eager" width="500" alt="" className="image---commuters-product-slider loaded tns-complete" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid-dashboard-benefits">
              <div className="container-benefits-card">
                <div className="benefits-card small-benefits-card">
                  ...
                  <div className="benefits-card__bg w-embed">
                    <svg width="361" height="439" viewBox="0 0 361 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
                      position: 'absolute',
                      top: 0,
                      ...
                      <g clipPath="url(#clip0_324_61061)">
                        <path d="M667.504 -302.75C704.683 -247.533 740.032 -178.713 759.642 -123.165C759.893 -122.36 759.48 -121.448 758.721 -121.246C758.532 -121.147 758.341 -121.144 758.151 -121.141C754.728 -120.8 673.261 -107.821 665.763 -106.177C595.859 -90.812 528.568 -55.2013 463.543 -20.7702C445.693 -11.339 427.182 -1.51627 409.324 7.43877C335.863 44.3869 249.794 85.0622 158.278 100.965C83.478 113.932 8.82959 106.704 -57.7018 80.0576C-127.302 52.1269 -184.275 3.89547 -222.439 -59.3069C-283.307 -160.148 -294.062 -295.8 -250.521 -413.371C-231.717 -464.155 -204.42 -508.028 -170.176 -543.392C-133.964 -580.789 -90.0262 -608.642 -40.1897 -625.064C84.4968 -666.123 223.053 -650.256 360.452 -579.078C478.4 -518.017 590.318 -417.331 667.407 -302.844L667.504 -302.75Z" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M-25.1328 91.6299C7.92478 -26.3438 -25.5488 -156.153 -121.58 -249.142C-165.943 -292.099 -215.043 -321.646 -270.341 -336.853" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M235.45 81.5785C234.737 -30.7559 189.921 -140.333 101.679 -225.779C-2.52757 -326.685 -137.335 -367.044 -267.943 -344.749" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M478.928 -29.4948C471.931 -138.728 424.58 -246.073 337.596 -330.301C158.644 -503.584 -103.117 -516.516 -267.451 -346.805" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M-270.338 -336.853C-242.699 -273.624 -110.011 -3.96736 173.418 -103.539C173.418 -103.539 220.676 -111.491 416.524 -249.563C524.36 -325.592 583.753 -357.79 615.348 -371.347" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_324_61061">
                          <rect width="361" height="439" rx="16" fill="currentColor"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card medium-benefits-card">
                  ...
                  <div className="benefits-card__bg w-embed">
                    <svg width="428" height="439" viewBox="0 0 428 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
                      position: 'absolute',
                      top: 0,
                      ...
                      <g clipPath="url(#clip0_2058_3788)">
                        ...
                        <path d="M354.818 157.669C365.21 91.9237 345.151 21.4503 294.511 -30.8466C264.249 -62.099 227.194 -82.65 188.156 -92.3745" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M590.368 205.083C579.281 136.421 546.865 64.4152 494.304 10.1347C410.309 -76.6075 294.89 -113.517 186.057 -95.0278" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M850.748 118.311C828.774 66.1899 795.131 14.2142 753.063 -29.2295C596.927 -190.474 354.966 -218.276 184.593 -101.576" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M689.45 -521.355C688.737 -409.021 643.921 -299.444 555.679 -213.998C451.472 -113.092 316.665 -72.733 186.057 -95.0277" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M932.928 -410.282C925.931 -301.049 878.58 -193.704 791.596 -109.475C612.644 63.807 350.883 76.7389 186.549 -92.9721" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M183.662 -102.924C211.301 -166.153 343.989 -435.809 627.418 -336.237C627.418 -336.237 674.676 -328.286 870.524 -190.214C978.36 -114.184 1037.75 -81.987 1069.35 -68.4294" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_2058_3788">
                          <rect width="428" height="439" rx="16" fill="currentColor"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card large-benefits-card">
                  ...
                  <div className="benefits-card__bg bottom w-embed">
                    <svg width="669" height="439" viewBox="0 0 669 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
                      position: 'absolute',
                      bottom: 0,
                      ...
                      <g clipPath="url(#clip0_2001_7918)">
                        ...
                        <path d="M559.256 131.584C581.23 183.705 614.873 235.681 656.941 279.125C813.077 440.369 1055.04 468.171 1225.41 351.471" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M720.554 771.25C721.267 658.916 766.083 549.339 854.325 463.893C958.531 362.987 1093.34 322.628 1223.95 344.923" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M477.076 660.177C484.072 550.944 531.424 443.599 618.408 359.37C797.36 186.088 1059.12 173.156 1223.46 342.867" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M1226.34 352.819C1198.7 416.048 1066.01 685.705 782.586 586.132C782.586 586.132 735.328 578.181 539.48 440.109C431.644 364.079 372.251 331.882 340.656 318.324" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_2001_7918">
                          <rect width="669" height="439" rx="16" fill="currentColor"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
                  ...
                  <div className="benefits-card__bg w-embed">
                    <svg width="361" height="439" viewBox="0 0 361 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      ...
                      <g clipPath="url(#clip0_2001_7875)">
                        ...
                        <path d="M42.7476 -382.088C20.7744 -329.967 -12.8691 -277.991 -54.9366 -234.547C-211.073 -73.3025 -453.034 -45.501 -623.407 -162.201" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M124.928 146.505C117.931 37.2723 70.5797 -70.0728 -16.4044 -154.301C-195.356 -327.584 -457.117 -340.516 -621.451 -170.805" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M-624.338 -160.853C-596.699 -97.624 -464.011 172.033 -180.582 72.4606C-180.582 72.4606 -133.324 64.5087 62.5238 -73.563C170.36 -149.592 229.753 -181.79 261.348 -195.347" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card large-benefits-card">
                  ...
                  <div className="text-body"></div>
                  <div className="benefits-card__bg w-embed">
                    <svg width="666" height="439" viewBox="0 0 666 439" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
                      position: 'absolute',
                      top: 0,
                      ...
                      <g clipPath="url(#clip0_2001_7859)">
                        ...
                        <path d="M618.137 158.63C585.079 40.6562 618.553 -89.1528 714.584 -182.142C758.946 -225.099 808.046 -254.646 863.345 -269.853" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M357.554 148.578C358.267 36.2441 403.083 -73.3326 491.325 -158.779C595.531 -259.685 730.339 -300.044 860.947 -277.749" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M114.076 37.5052C121.072 -71.7277 168.424 -179.073 255.408 -263.301C434.36 -436.584 696.12 -449.516 860.455 -279.805" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M863.342 -269.853C835.702 -206.624 703.015 63.0326 419.586 -36.5394C419.586 -36.5394 372.328 -44.4913 176.48 -182.563C68.644 -258.592 9.25074 -290.79 -22.3441 -304.347" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_2001_7859">
                          <rect width="666" height="439" rx="16" fill="currentColor"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
              ...
              <div className="container-benefits-card">
                <div className="benefits-card medium-benefits-card">
                  ...
                  <div className="benefits-card__bg w-embed">
                    <svg width="433" height="440" viewBox="0 0 433 440" fill="none" xmlns="http://www.w3.org/2000/svg" style={{
                      width: '100%',
                      height: 'auto',
                      position: 'absolute',
                      bottom: '-5px',
                      ...
                      <g clipPath="url(#clip0_2002_7932)">
                        ...
                        <path d="M254.664 301.309C210.057 350.783 142.633 379.498 70.1257 372.939C26.7957 369.019 -12.4795 353.07 -44.5805 328.762" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M439.57 455.094C379.194 489.663 302.81 509.71 227.553 502.902C107.288 492.022 6.03465 425.288 -47.9897 328.824" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M535.725 712.733C481.37 728.411 419.792 734.898 359.556 729.448C135.986 709.218 -37.7289 538.084 -54.0419 331.804" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M-63.2762 989.789C23.6983 918.506 80.7919 814.569 91.7978 691.96C104.795 547.168 51.4289 416.635 -47.9897 328.824" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M176.188 1109.68C256.777 1035.45 310.525 930.948 321.371 810.093C343.685 561.46 189.178 349.208 -46.1804 327.912" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                        <path d="M-55.7178 331.935C-87.5304 393.289 -213.894 666.494 41.7296 824.797C41.7296 824.797 77.6222 856.638 308.141 922.418C435.072 958.635 497.454 984.674 527.861 1000.77" stroke="currentColor" strokeOpacity="0.5" strokeWidth="1"></path>
                      </g>
                      <defs>
                        <clipPath id="clip0_2002_7932">
                          <rect width="433" height="440" rx="16" fill="currentColor"></rect>
                        </clipPath>
                      </defs>
                    </svg>
                  </div>
      ...
      <section className="start-journey__section">
        <div className="w-layout-blockcontainer start-journey__container w-container">
          <h4 className="text-h2 font-medium no-margins start-journey__title">
            Start your journey
          </h4>
          <div className="start-journey__button-wrap" style={{opacity: 1}}>
